...
test.describe('PrintOS', () => {

  test.describe('Verify user is able to login to HPBW site', () => {

    test('Example #1', { tag: ['@printoslogin'] }, async ({ Given, Then, page }) => { 
      ...
      await Then('Click on My applications button', null, { page }); 
      await Then('Click on Organization Menu', null, { page }); 
    });
