...
test.describe('Open Google', () => {
  ...
  test('Buy tokens', { tag: ['@BuyTokens'] }, async ({ Given, Then, page }) => { 
    ...
    await Then('Click on 6 Tokens button', null, { page }); 
